...
import { Upload, Brain, Loader2, CheckCircle, AlertCircle, ArrowLeft } from "lucide-react";
...
export default function DLDiagnosis() {
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-1">
                  Upload CT scan for AI-powered lung cancer detection
                </p>
              </div>
            </div>
          </motion.div>
                  ...
                  <Card className="shadow-xl border-none bg-white/80 backdrop-blur-sm h-full">
                    <CardContent className="flex flex-col items-center justify-center h-full p-12 text-center">
                      ...
                      <p className="text-slate-600 mb-6">
                        Upload a CT scan image and click "Analyze with AI" to get diagnosis results
                      </p>
                      <div className="text-left bg-blue-50 rounded-lg p-4 w-full">
                        <h4 className="font-semibold text-blue-900 mb-2">Detection Types:</h4>
